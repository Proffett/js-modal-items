...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener("submit", (e) => {
      ...
      //1) Object.entries() -  преобразование в матрицу, массивы
      //2) Object.fromEntries() - преобразование в объект
      //3) JSON.stringify() - преобразование в json
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_1__.default)(".timer", "2021-02-11");
